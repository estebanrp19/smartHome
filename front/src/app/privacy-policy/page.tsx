        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <ul className="list-disc pl-6">
              <li>
                <strong>Correo electrónico:</strong> contacto@smarthome.com.co
              </li>
              <li>
                <strong>Teléfono:</strong> +57 (315) 244 76 23
              </li>
              <li>
                <strong>Dirección:</strong> Calle 167D #8-58, Bogotá, Colombia
              </li>
            </ul>
          </div>
        </div>
